...
function valsoc(form1) {
	if ((form1.elcodigo.value == "") || (form1.lacedula.value == "") || (form1.elnombre.value == "") || (form1.elapellido.value == "" )
		|| (form1.elcargo.value == "" ) || (form1.lafechaingreso.value == "" ) || (form1.elnrocuenta.value == "" ) 
...
function valreg(form1) {
if (parseFloat(form1.monto.value) == 0)  {
	alert("Debe indicar el monto de la factura"); return false; }
else 
if (parseFloat(form1.monto.value) <= 0)  {
	alert("El monto de la factura debe ser mayor a cero (0)"); form1.monto.focus(); return false; }
if (form1.fecha.value == '') {
		alert("No puede quedar la fecha en blanco"); form1.fecha.focus(); return false; }
if (form1.factura.value == '') {
		alert("No puede quedar la fecha en blanco"); form1.factura.focus(); return false; }
return true
}
...
function conciliacion(form1) {
	...
	if (parseFloat(form1.diferencia.value) != parseFloat(form1.diferenciacon.value))
	{
...
function ventana_pdf(numero,codigo,nro,nombre)
{
...
function lookup8(inputString8) {
	if(inputString8.length == 0) {
		// Hide the suggestion box.
		$('#suggestions8').hide();
	} else {
		$.post("rpc8.php", {queryString: ""+inputString8+""}, function(data){
			if(data.length >0) {
				$('#suggestions8').show();
